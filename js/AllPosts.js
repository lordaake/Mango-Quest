document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        const [totalResponse, tags] = await Promise.all([
            fetch("https://mangoquest.tordlarsson.org/wp-json/wp/v2/posts"),
            fetch("https://mangoquest.tordlarsson.org/wp-json/wp/v2/tags").then(response => response.json())
        ]);
        ...
        async function loadPosts(reset = false) {
            ...
            let url = `https://mangoquest.tordlarsson.org/wp-json/wp/v2/posts?_embed&per_page=6&page=${page}`;
